export default {
  ...
  'pages.searchTable.createForm.newRule': '新建应用',
  'pages.searchTable.updateForm.ruleConfig': '規則配置',
  'pages.searchTable.updateForm.basicConfig': '基本信息',
  'pages.searchTable.updateForm.ruleName.nameLabel': '应用名稱',
  ...
  'pages.searchTable.ruleName': '应用名稱爲必填項',
  'pages.searchTable.titleCallNo': '服務調用次數',
  'pages.searchTable.titleStatus': '集成狀態',
  ...
  'pages.searchTable.titleUpdatedAt': '创建時間',
  ...
  'pages.appmanager.owner':'创建者',
  'pages.login.title':'签名管理系统',
  'pages.login.subTitle':'欢迎使用签名管理系统',
};
